...
namespace SQLiteBrowser
{
    ...
    public class SQLite
    {
        ...
        static extern SQLite.Constants sqlite3_prepare_v2(IntPtr db, string zSql,
        ...
        [DllImport("sqlite3.dll",
          EntryPoint = "sqlite3_column_origin_name")]
        ...
        static extern string sqlite3_column_text(
          IntPtr stmHandle, int iCol);
        ...
        {
            if (sqlite3_finalize(stmHandle) != SQLite.Constants.SQLITE_OK)
                throw new SQLiteException(
                  "Could not finalize SQL statement.");
        }
    }
}
